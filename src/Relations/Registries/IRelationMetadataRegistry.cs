...
namespace Zentient.Abstractions.Relations.Registries
{
    ...
    public interface IRelationMetadataRegistry
    {
        ...
        /// <exception cref="ArgumentNullException">Thrown if <paramref name="relationDefinition"/> or <paramref name="displayName"/> is <see langword="null"/>.</exception>
        ...
        /// </remarks>
        void SetDisplayName(Type relationDefinition, string displayName);
        ...
        /// <exception cref="ArgumentNullException">Thrown if <paramref name="relationDefinition"/> or <paramref name="description"/> is <see langword="null"/>.</exception>
        /// <exception cref="ArgumentException">Thrown if <paramref name="relationDefinition"/> does not implement <see cref="IRelationDefinition"/>.</exception>
        /// <remarks>
        /// Provides detailed context about the relation's semantic meaning and application.
        /// </remarks>
        void SetDescription(Type relationDefinition, string description);
        ...
        /// <exception cref="ArgumentNullException">Thrown if <paramref name="relationDefinition"/> or <paramref name="category"/> is <see langword="null"/>.</exception>
        /// <exception cref="ArgumentException">Thrown if <paramref name="relationDefinition"/> does not implement <see cref="IRelationDefinition"/>.</exception>
        /// <remarks>
        /// Useful for organizational purposes in tools or for automated processing based on functional groupings.
        /// </remarks>
        void SetCategory(Type relationDefinition, string category);
        ...
        /// <exception cref="ArgumentNullException">Thrown if <paramref name="relationDefinition"/>, <paramref name="key"/>, or <paramref name="value"/> is <see langword="null"/>.</exception>
        /// <exception cref="ArgumentException">Thrown if <paramref name="relationDefinition"/> does not implement <see cref="IRelationDefinition"/>, or if <paramref name="key"/> is empty.</exception>
        /// <remarks>
        ...
        /// </remarks>
        void SetMetadata(Type relationDefinition, string key, string value);
        ...
        /// </summary>
        /// <param name="relationDefinition">The <see cref="Type"/> of the relation to remove all associated metadata from.</param>
        ...
        /// </remarks>
        void Clear(Type relationDefinition);
    }
}
