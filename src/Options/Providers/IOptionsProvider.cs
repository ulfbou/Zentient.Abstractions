...
namespace Zentient.Abstractions.Options.Providers
{
    ...
    {
        /// <summary>
        /// Retrieves an instance of options based on their definition type.
        /// </summary>
        /// <typeparam name="TOptionsType">The type of the option definition.</typeparam>
        /// <typeparam name="TValue">The concrete type of the option values.</typeparam>
        /// <returns>
        /// An <see cref="IOptions{TOptionsType, TValue}"/> instance representing the configured options, if it exists; 
