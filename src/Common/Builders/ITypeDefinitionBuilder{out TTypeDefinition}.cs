// <copyright file="ITypeDefinitionBuilder{out TTypeDefinition}.cs" company="Zentient Framework Team">
...
namespace Zentient.Abstractions.Common.Builders
{
    ...
    /// </summary>
    /// <typeparam name="TTypeDefinition">The specific type definition being built.</typeparam>
    public interface ITypeDefinitionBuilder<out TTypeDefinition>
        where TTypeDefinition : ITypeDefinition
    {
        ...
        ITypeDefinitionBuilder<TTypeDefinition> WithId(string id);
        ...
        ITypeDefinitionBuilder<TTypeDefinition> WithName(string name);
        ...
        ITypeDefinitionBuilder<TTypeDefinition> WithVersion(string version);
        ...
        ITypeDefinitionBuilder<TTypeDefinition> WithDescription(string description);
        ...
        ITypeDefinitionBuilder<TTypeDefinition> WithDisplayName(string displayName);
        ...
        ITypeDefinitionBuilder<TTypeDefinition> WithCategory(string category);
        ...
        ITypeDefinitionBuilder<TTypeDefinition> WithMetadata(string key, object? value);
